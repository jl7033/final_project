...
In MLB, the decimal after innings pitched represents the number of thirds of an inning pitched rather than the proportion of innings pitched. For instance, a pitcher with 138.2 innings pitched has actually thrown 138 and 2/3 innings. We corrected for that in the code above.
