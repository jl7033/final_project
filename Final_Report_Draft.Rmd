...
ip_plot = merged_pitching |> 
  ...
  labs(title = "Distribution of IP, MLB Pitchers, 2022",
       x = "Innings Pitched",
       y = "Pitcher Count") +
  theme_bw()
...
bb_plot = merged_pitching |>
  ...
  geom_histogram(fill = "darkgreen", col = "black") +
    labs(title = "Distribution of BB/9, MLB Pitchers, 2022",
       x = "BB/9",
       y = "Pitcher Count") +
  theme_bw()
...
so_plot = merged_pitching |>
  ...
  geom_histogram(fill = "orange", col = "black") +
    labs(title = "Distribution of SO/9, MLB Pitchers, 2022",
       x = "SO/9",
       y = "Pitcher Count") +
  theme_bw()

plot_grid(ip_plot, era_plot, bb_plot, so_plot)
